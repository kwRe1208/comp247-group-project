...
def data_load():
    ...
    import pandas as pd
    import numpy as np
    dataset_path = r'D:\Centennial\Semester2\Comp247 machine Learning\Project\KSI.csv'
    ...
    df.to_csv(r'D:\Centennial\Semester2\Comp247 machine Learning\Project\KSI_cleaned.csv', index=False)
